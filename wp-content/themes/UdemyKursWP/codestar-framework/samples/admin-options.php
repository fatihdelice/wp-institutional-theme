...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    ...
    array(
      ...
      'type'  => 'textarea',
      'title' => 'Site Footer Açıklama Alanı',
    ),
    array(
      'id'    => 'site_footer',
      'type'  => 'textarea',
...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    array(
      'id'    => 'calisanlar_baslik',
      'type'  => 'text',
      'title' => 'Başlık',
    ),
    array(
      'id'    => 'calisanlar_aciklama',
      'type'  => 'textarea',
      'title' => 'Açıklama',
    ),
...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    array(
      ...
      'type'  => 'switcher',
      'title' => 'Neler Yaparız Alanı (Aktif/Pasif)',
    ),
    array(
      'id'    => 'ikonlar_switch',
      'type'  => 'switcher',
      'title' => 'İkonlar Alanı (Aktif/Pasif)',
    ),
    array(
      'id'    => 'hakkimizda_calisanlar_switch',
      'type'  => 'switcher',
      'title' => 'Çalışanlar Alanı (Aktif/Pasif)',
    ),
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'type'  => 'switcher',
          'title' => 'Buton Olsun mu?',
        ),
        array(
          'id'    => 'slider_buton_text',
          'type'  => 'text',
          'title' => 'Butonun Üzerindeki Yazı',          
          'dependency' => array( 'slider_buton_switch', '==', 'true' ),
        ),
        array(
          'id'    => 'slider_buton_url',
          'type'  => 'text',
          'title' => 'Buton Hedef Link',
          'dependency' => array( 'slider_buton_switch', '==', 'true' ),
        ),
      ),
    ),
    ...
    array(
      ...
      'accordions' => array(
        array(
          ...
          'fields' => array(
            array(
              'id'    => 'homepage_hakkimizda_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Bu Alan Açık/Kapalı',
            ),
            array(
            ...
            array(
              'id'    => 'homepage_hakkimizda_alan_1_icon',
              'type'  => 'icon',
              'title' => '1. Alanın İkonu',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_1_text',
              'type'  => 'text',
              'title' => '1. Alanın Başlığı',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_1_aciklama',
              'type'  => 'text',
              'title' => '1. Alanın Açıklaması',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_2_icon',
              'type'  => 'icon',
              'title' => '2. Alanın İkonu',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_2_text',
              'type'  => 'text',
              'title' => '2. Alanın Başlığı',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_2_aciklama',
              'type'  => 'text',
              'title' => '2. Alanın Açıklaması',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_3_icon',
              'type'  => 'icon',
              'title' => '3. Alanın İkonu',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_3_text',
              'type'  => 'text',
              'title' => '3. Alanın Başlığı',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_3_aciklama',
              'type'  => 'text',
              'title' => '3. Alanın Açıklaması',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_4_icon',
              'type'  => 'icon',
              'title' => '4. Alanın İkonu',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_4_text',
              'type'  => 'text',
              'title' => '4. Alanın Başlığı',
            ),
            array(
              'id'    => 'homepage_hakkimizda_alan_4_aciklama',
              'type'  => 'text',
              'title' => '4. Alanın Açıklaması',
            ),
          )
        ),
        array(
          'title'  => 'Projeler Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_proje_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
            ...
            array(
              'id'    => 'homepage_proje_baslik',
              'type'  => 'text',
              'title' => 'Bu Alanın Başlığı',
            ),
            array(
              'id'    => 'homepage_proje_number',
              'type'  => 'number',
              'title' => 'Kaç Adet Gösterilsin',
              'after' => 'Hepsini göstermek için -1 yazın.'
            ),
          ),
        ),
        array(
          'title'  => 'Neler Yaparız Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_neler_yapariz_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Hakkımızdaki Neler Yaparız Alanı Açık/Kapalı',
            ),
          ),
        ),
        array(
          ...
          'fields' => array(
            array(
              'id'    => 'homepage_ikonlar_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Hakkımızdaki İkonlar Alanı Açık/Kapalı',
            ),
          ),
        ),
        array(
          'title'  => 'Çalışanlar Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_calisanlar_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Çalışanlar Alanı Açık/Kapalı',
            ),
            array(
              'id' =>'homepage_calisanlar_baslik',
              'type'  => 'text',
              'title' => 'Çalışanlar Alanı Başlığı',
            ),
            array(
              'id' =>'homepage_calisanlar_aciklama',
              'type'  => 'textarea',
              'title' => 'Çalışanlar Alanı Açıklama',
            ),
            array(
              'id' =>'homepage_calisanlar_number',
              'type'  => 'number',
              'title' => 'Çalışan Gösterim Adedi',
              'after' => 'Hepsini göstermek için -1 yazın.'
            ),
          ),
        ),
        array(
          'title'  => 'Sık Sorulan Sorular Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_sss_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'SSS Modülü Açık/Kapalı',
            ),
          ),
        ),
        array(
          ...
          'fields' => array(
            array(
              'id'    => 'homepage_grafik_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Grafik Modülü Açık/Kapalı',
            ),
          ),
        ),
        array(
          'title'  => 'Son Yazılar Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_blog_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Son Yazılar Açık/Kapalı',
            ),
            array(
              'id'    => 'homepage_blog_baslik',
              'type'  => 'text',
              'title' => 'Başlık',
            ),
            array(
              'id'    => 'homepage_blog_aciklama',
              'type'  => 'textarea',
              'title' => 'Açıklama',
            ),
            array(
              'id'    => 'homepage_blog_number',
              'type'  => 'number',
              'title' => 'Gösterilecek Blog Sayısı',
              'after' => 'Hepsini göstermek için -1 yazın.'
            ),
          ),
        ),
        array(
          ...
          'fields' => array(
            array(
              'id'    => 'homepage_musteri_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Müşteri Yorumları Alanı Açık/Kapalı',
            ),
          ),
        ),
        array(
          'title'  => 'Referanslar Alanı',
          'fields' => array(
            array(
              'id'    => 'homepage_referans_switch',
              'type'  => 'switcher',
              'text_on' =>'Açık',
              'text_off' =>'Kapalı',
              'text_width' =>'100',
              'title' => 'Referanslar Alanı Açık/Kapalı',
            ),
            array(
              'id'    => 'homepage_referans_baslik',
              'type'  => 'text',
              'title' => 'Başlık',
            ),
            array(
              'id'    => 'homepage_referans_aciklama',
              'type'  => 'textarea',
              'title' => 'Açıklama',
            ),
            array(
              'id'          => 'homepage_referans_galeri',
              'type'        => 'gallery',
              'title'       => 'Referans Logoları',
              'add_title'   => 'Logo Yükle',
              'edit_title'  => 'Logo Düzenle',
              'clear_title' => 'Logo Sil',
            ),
          ),
        ),
      )
...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    array(
      'id'    => 'sss_baslik',
      'type'  => 'text',
      'title' => 'Sık Sorulan Sorular Alan Başlığı',
    ),
    array(
      'id'     => 'sorular',
      'type'   => 'repeater',
      'title'  => 'Sık Sorulan Sorular Modülü',
      'fields' => array(
        array(
          'id'     => 'sorular_fieldset',
          'type'   => 'fieldset',
          ...
          'fields' => array(
            array(
              'id'    => 'sorular_fieldset_ikon',
              'type'  => 'icon',
              'title' => 'Soru İkonu',
            ),
            array(
              'id'    => 'sorular_fieldset_soru',
              'type'  => 'text',
              'title' => 'Soru',
            ),
            array(
              'id'    => 'sorular_fieldset_cevap',
              'type'  => 'textarea',
              'title' => 'Cevap',
            ),
          ),
...
CSF::createSection( $prefix, array(
  ...
  'fields' => array(
    array(
      'id'    => 'grafik_baslik',
      'type'  => 'text',
      'title' => 'Grafik Alan Başlığı',
    ),
    array(
      'id'     => 'grafik_bilgi',
      'type'   => 'repeater',
      'title'  => 'Grafik Alan bilgileri',
      'fields' => array(
        array(
          'id'     => 'grafik_bilgi_fieldset',
          'type'   => 'fieldset',
          'title'  => 'Grafik Bilgileri',
          'fields' => array(
            array(
              'id'    => 'grafik_bilgi_fieldset_text',
              'type'  => 'text',
              'title' => 'Text',
            ),
            array(
              'id'    => 'grafik_bilgi_fieldset_number',
              'type'  => 'number',
              'title' => 'Sayı',
            ),
          ),
